            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('print.allInvoice') }}" class="btn btn-sm btn-warning">
                ...
                <div class="table-responsive py-4">
                    <table class="table table-flush" id="datatable-basic">
                        ...
                        <tbody>
													...
													<tr>
															<td>{{ $i + 1 }}</td>
															<td class="{{ isset($d->user) ? '' : 'text-danger' }}">{{ isset($d->user) ? $d->user->name : 'User tidak ada' }}</td>
															...
															<td>
																	<a href="{{ route('invoice.print', $d->id) }}" class="btn btn-sm btn-warning">
