					...
					<form class="validation" novalidate method="POST" action="">
						...
						<div class="form-row">
							...
							<div class="col-md-4 mb-3">
								...
								<input type="number" name="amount" class="form-control" id="amount" placeholder="ex: 150000" required value="{{ (empty($data) ? old('amount') : $data->amount) }}">
								<div class="invalid-feedback">
							...
							<div class="col-md-4 mb-3">
								...
								<input type="text" name="info" class="form-control" id="info" placeholder="" value="{{ (empty($data) ? old('info') : $data->info) }}">
							</div>
						</div>
