        ...
        <div class="row">
          <div class="col">
            <h5 class="card-title text-uppercase text-muted mb-0">Dana Masuk</h5>
						<span class="h2 font-weight-bold mb-0">Rp. {{ number_format($incoming) }}</span>
          </div>
          <div class="col-auto">
...
<div class="mb-5 mt-4 bg-primary p-4 rounded-lg">
	<h1 class=" text-white m-0">Selamat Datang {{ Auth::user()->name }}</h1>
</div>
@endsection