       ...
       <div class="row align-items-center">
         <div class="col-lg-6">
           <div class="pr-5">
             ...
             <h2 class="display-4 text-white font-weight-light">{{ setting('title') }}</h2>
             <p class="text-white mt-4">Pembayaran SPP Online Berbasis Web</p>
             <div class="mt-5">
               <a href="mailto:mhdfarhan5148@gmail.com" target="_blank" class="btn btn-neutral my-2">E - mail</a>
   ...
   <section class="py-7">
     <div class="container">
       <div class="row row-grid justify-content-center">
         <div class="col-lg-8 text-center">
           <h2 class="display-3 text-white">E-SPP <span class="text-success">{{ setting('title') }}</span></h2>
